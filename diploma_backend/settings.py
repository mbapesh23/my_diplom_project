...
INSTALLED_APPS = [
    ...
    # Удалено: drf_spectacular (так как библиотека не установлена)
    'corsheaders',
    'rest_framework',
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,
    # Строка ниже удалена, так как она ссылается на несуществующую библиотеку
    # 'DEFAULT_SCHEMA_CLASS': 'drf_spectacular.openapi.AutoSchema', 
}

# Настройки почты берутся из .env
